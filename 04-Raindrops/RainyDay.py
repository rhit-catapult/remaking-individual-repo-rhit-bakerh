...
def main():
    ...
    pygame.display.set_caption("Julia's Un-Rainy Day")
    # TODO 2: Make a Clock
    ...
    Mike = Hero(screen, 350, 400, "mike_umbrella.png", "mike.png")
    ...
    cloud = Cloud(screen, 300, 50, "image-removebg-preview.png")
