...
def main():
    ...
    image2 = pygame.image.load("2dogs.JPG")
    ...
    font1 = pygame.font.SysFont("Comic Sans MS", 28)
    ...
    while True:
        ...
        caption2 = font2.render("Cute Puppies!", True, PINK)
        screen.blit(caption2, (image2.get_width() // 2 - caption2.get_width() // 2,
                               image2.get_height() - 65))
