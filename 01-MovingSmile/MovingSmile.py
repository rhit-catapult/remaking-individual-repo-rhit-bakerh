...
def main():
     ...
     while True:
        ...
        pygame.draw.circle(screen, (225, 225, 225), (240, 160), 40)  # white eye
        pygame.draw.circle(screen, (0, 0, 0), (240, 160), 40, 3)  # black outline
        pygame.draw.circle(screen, (0, 0, 0), (242 - eye_x -1, 162 - eye_y - 1), 15)  # black pupil

        pygame.draw.circle(screen, (225, 225, 225), (400, 160), 40)  # white eye
        pygame.draw.circle(screen, (0, 0, 0), (400, 160), 40, 3)  # black outline
        pygame.draw.circle(screen, (0, 0, 0), (400 - eye_x -1, 162 - eye_y - 1), 15)  # black pupil

        # TODO 1: Draw a nose
        # Suggestion: color (80,0,0) location (320,245), radius 10
        # API --> pygame.draw.circle(screen, (r,g,b), (x, y), radius, thickness)
        pygame.draw.circle(screen, (0,0,0), (320,245), 30)
